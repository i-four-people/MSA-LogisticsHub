package com.logistcshub.gateway.config;


import com.logistcshub.gateway.dto.CustomHeader;
import com.logistcshub.gateway.jwt.JwtUtil;
...
public class SecurityConfig {
    ...
    public WebFilter jwtAuthenticationFilter() {
        return (exchange, chain) -> {
            ...
            if (path.startsWith("/api/auth")) { // auth 관련 요청은 토큰 x >> 검증 x
                log.info("{} 요청 #####", path);
